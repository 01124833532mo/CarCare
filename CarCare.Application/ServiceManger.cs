...
namespace CarCare.Core.Application
{
	...
	public class ServiceManger : IServiceManager
	{
		...
		private readonly Lazy<IRequestService> _userRequestService;

		public ServiceManger(Func<IAuthService> authfactory, Func<IVehicleService> vehiclefactory, Func<IFeedBackService> feedBackfactory, Func<IServiceTypeService> servicetypesfactory, Func<IContactService> contactServicefactory, Func<IRequestService> userRequestServicefactory)
		{
			...
			_contactService = new Lazy<IContactService>(contactServicefactory, LazyThreadSafetyMode.ExecutionAndPublication);
			_userRequestService = new Lazy<IRequestService>(userRequestServicefactory, LazyThreadSafetyMode.ExecutionAndPublication);
		...
		public IRequestService RequestService => _userRequestService.Value;
	}
