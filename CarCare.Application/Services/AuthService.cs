...
namespace CarCare.Core.Application.Services
{
    ...
    public class AuthService(
        ...
        , IMapper mapper
        , IEmailServices emailServices) : IAuthService
    {
   ...
   .ToListAsync();
        ...
        public async Task<SuccessDto> ConfirmationCodeSendByEmailAsync(ForgetPasswordByEmailDto confirmationCodeDto)
        {
            var result = await ForgetPasswordByEmailasync(confirmationCodeDto);

            return result;
        }

        public async Task<SuccessDto> ConfirmationCodeSendByPhoneAsync(ForgetPasswordByPhoneDto confirmationCodeDto)
        {
            var result = await ForgetPasswordByPhoneAsync(confirmationCodeDto);
