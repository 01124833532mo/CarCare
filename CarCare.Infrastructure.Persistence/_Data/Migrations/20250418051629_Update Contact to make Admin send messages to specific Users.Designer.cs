...
namespace CarCare.Infrastructure.Persistence._Data.Migrations
{
    ...
    [Migration("20250418051629_Update Contact to make Admin send messages to specific Users")]
    partial class UpdateContacttomakeAdminsendmessagestospecificUsers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarCare.Core.Domain.Entities.Orders.ServiceRequest", b =>
                {
                    ...
                    b.Property<string>("BusnissStatus")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
