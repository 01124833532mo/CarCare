...
namespace CarCare.Core.Application
{
    public class ServiceManger : IServiceManager
    {
        ...
        public ServiceManger(Func<IAuthService> authfactory, Func<IVehicleService> vehiclefactory, Func<IFeedBackService> feedBackfactory, Func<IServiceTypeService> servicetypesfactory)
        {
