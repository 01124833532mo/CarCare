...
namespace CarCare.Apis.Controllers.Controllers.Account
{
    ...
    public class AccountController(IServiceManager serviceManager) : BaseApiController
    {
        ...
        [HttpPut("GetTechLocation")]
        public async Task<ActionResult<TechDto>> GetTechLocation([FromQuery] double techLatitude, [FromQuery] double techLongitude)
        {
            var result = await serviceManager.AuthService.GetTechLocationAsync(User, techLatitude, techLongitude);
            return Ok(result);
        }
